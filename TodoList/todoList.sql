...
CREATE TABLE MEMBERSHIP(
	BOARD_ID VARCHAR2(20) CONSTRAINT BOARD_ID_PK PRIMARY KEY,
	BOARD_PW VARCHAR2(20),
	BOARD_NAME VARCHAR2(15),
	MEMBER_NUM NUMBER CONSTRAINT MEMBER_NUM_UQ UNIQUE,
	NICKNAME VARCHAR2(15) CONSTRAINT NICKNAME_UP UNIQUE,
	ADDRESS VARCHAR2(50),
	SECURITY_NUM CHAR(14)
);

CREATE SEQUENCE BOARDMAIN NOCACHE;

INSERT INTO MEMBERSHIP(BOARD_ID, BOARD_PW, BOARD_NAME,SCEURITY_NUM,ADDRESS,MEMBER_NUM, NICKNAME)
VALUES(?,?,?,?,?,?,?);
...
CREATE TABLE BOARDMAIN(
	BOARD_NO NUMBER CONSTRAINT BOARD_NO_PK PRIMARY KEY,
	NICKNAME VARCHAR2(15) CONSTRAINT NICKNAME_UK REFERENCES MEMBERSHIP(NICKNAME),
	BOARD_TITLE VARCHAR2(15),
	REGDATE DATE,
	BOARD_TEXT VARCHAR2(1000)
);


INSERT INTO BOARDMAIN (BOARD_NO, NICKNAME, BOARD_TITLE, REGDATE, BOARD_TEXT)
VALUES(1, '모끼', '테스트', DEFAULT, 'ㅁㄴㅇㅁㄴㅇ');

COMMIT;

SELECT * FROM BOARDMAIN;

ALTER TABLE BOARDMAIN
MODIFY REGDATE DEFAULT SYSDATE;

DELETE FROM BOARDMAIN
WHERE BOARD_NO = 1;
